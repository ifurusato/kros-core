...
class Experiment(Component):
    ...
    argument is optional; if None 'x-unknown' is used.
    ...
    def external_clock(self):
        ''' Return the ExternalClock (or None if unavailable). '''
    ...
    # ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
    def close(self):
        ''' Close the Experiment and release any resources. '''
        if not self.closed:
