...
#               await self._pxblish_message(message_bus)
                self._log.info(Fore.BLUE + '[{:03d}] A2. END loop...'.format(_count))
                await asyncio.sleep(1.0)
            else:
                self._log.info(Fore.BLUE + '[{:03d}] A2. END SUPPRESSED loop...'.format(_count))
                await asyncio.sleep(1.0)
#           time.sleep(1.0)
