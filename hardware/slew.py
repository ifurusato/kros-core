...
#                   _value, _diff, 100.0 * self._slew_rate.ratio, target_value))
    ...
    # ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
    def enable(self):
        self._log.info(Fore.MAGENTA + '🌸 starting slew limiter with rate limit of {:5.3f}/cycle.'.format(self._slew_rate.limit))
        self._start_time = self._millis()
        Component.enable(self)
    
    def release(self):
        Component.release(self)
        self._log.info(Fore.MAGENTA + '🌸 component released.')

    def suppress(self):
        Component.suppress(self)
        self._log.info(Fore.MAGENTA + '🌸 component suppressed.')

    def disable(self):
        Component.disable(self)
        self._log.info(Fore.MAGENTA + '🌸 component disabled.')
